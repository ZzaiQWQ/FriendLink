...
public final class FriendLinkClient implements ClientModInitializer {
    ...
    private static void registerCommands() {
        ClientCommandRegistrationCallback.EVENT.register((dispatcher, registryAccess) -> dispatcher.register(
            ClientCommandManager.literal("friendlink")
                .then(ClientCommandManager.literal("id").executes(context -> {
                ...
                .then(ClientCommandManager.literal("friends").executes(context -> {
                    Minecraft minecraft = Minecraft.getInstance();
                ...
                .then(ClientCommandManager.literal("presence").executes(context -> {
                    Minecraft minecraft = Minecraft.getInstance();
                ...
                .then(ClientCommandManager.literal("signaling").executes(context -> {
                    Minecraft minecraft = Minecraft.getInstance();
                    User user = minecraft.getUser();
                ...
                .then(ClientCommandManager.literal("listen").executes(context -> {
                    Minecraft minecraft = Minecraft.getInstance();
                ...
                .then(ClientCommandManager.literal("connect")
                    .then(ClientCommandManager.argument("peerPmid", StringArgumentType.word()).executes(context -> {
                        Minecraft minecraft = Minecraft.getInstance();
